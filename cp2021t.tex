...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;()\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{b})\mathrel{=}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Sum},(\Varid{b},\Varid{c}))\mathrel{=}(\mathbin{+})\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Product},(\Varid{b},\Varid{c}))\mathrel{=}(\mathbin{*})\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{Negate},\Varid{b})\mathrel{=}\mathbin{-}\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{E},\Varid{b})\mathrel{=}\Varid{expd}\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{clean}\;(\Conid{Bin}\;\Varid{op}\;\Varid{a}\;\Varid{b})\mid (\Varid{op}\equiv \Conid{Product}\mathrel{\wedge}(\Varid{a}\equiv (\Conid{N}\;\mathrm{0})))\mathrel{=}\Varid{outExpAr}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mid (\Varid{op}\equiv \Conid{Product}\mathrel{\wedge}(\Varid{b}\equiv (\Conid{N}\;\mathrm{0})))\mathrel{=}\Varid{outExpAr}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\hsindent{20}{}\<[20]%
\>[20]{}\mid \Varid{otherwise}\mathrel{=}i_2\;(i_2\;(i_1\;(\Varid{op},(\Varid{a},\Varid{b}))))\mbox{\onelinecomment Como verifico se a == N a}{}\<[E]%
\\
\>[B]{}\Varid{clean}\;(\Conid{Un}\;\Varid{a}\;\Varid{b})\mathrel{=}i_2\;(i_2\;(i_2\;(\Varid{a},\Varid{b}))){}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment }{}\<[E]%
\\
...
\\
\>[B]{}\Varid{sd\char95 gen}\mathrel{=}{}\<[11]%
\>[11]{}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;()\mathrel{=}(\Conid{X},\Conid{N}\;\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{b})\mathrel{=}(\Conid{N}\;\Varid{b},\Conid{N}\;\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Sum},((\Varid{b},\Varid{c}),(\Varid{d},\Varid{e})))\mathrel{=}(\Conid{Bin}\;\Conid{Sum}\;\Varid{b}\;\Varid{d},\Conid{Bin}\;\Conid{Sum}\;\Varid{c}\;\Varid{e}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Product},((\Varid{b},\Varid{c}),(\Varid{d},\Varid{e})))\mathrel{=}(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{d},\Conid{Bin}\;\Conid{Sum}\;(\Conid{Bin}\;\Conid{Product}\;\Varid{b}\;\Varid{e})\;(\Conid{Bin}\;\Conid{Product}\;\Varid{c}\;\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{Negate},(\Varid{b},\Varid{c}))\mathrel{=}{}\<[25]%
\>[25]{}(\Conid{Un}\;\Conid{Negate}\;\Varid{b},\Conid{Un}\;\Conid{Negate}\;\Varid{c}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{E},(\Varid{b},\Varid{c}))\mathrel{=}{}\<[20]%
\>[20]{}(\Conid{Un}\;\Conid{E}\;\Varid{b},\Conid{Bin}\;\Conid{Product}\;(\Conid{Un}\;\Conid{E}\;\Varid{b})\;\Varid{c}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{25}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ad\char95 gen}\;\Varid{a}{}\<[11]%
\>[11]{}\mathrel{=}{}\<[11E]%
\>[14]{}\alt{\Varid{g1}}{\alt{\Varid{g2}}{\alt{\Varid{g3}}{\Varid{g4}}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g1}\;()\mathrel{=}(\Varid{a},\mathrm{1}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g2}\;(\Varid{b})\mathrel{=}(\Varid{b},\mathrm{0}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Sum},((\Varid{b},\Varid{c}),(\Varid{d},\Varid{e})))\mathrel{=}(\Varid{b}\mathbin{+}\Varid{d},\Varid{c}\mathbin{+}\Varid{e}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g3}\;(\Conid{Product},((\Varid{b},\Varid{c}),(\Varid{d},\Varid{e})))\mathrel{=}(\Varid{b}\mathbin{*}\Varid{d},(\Varid{b}\mathbin{*}\Varid{e})\mathbin{+}(\Varid{c}\mathbin{*}\Varid{d})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{Negate},(\Varid{b},\Varid{c}))\mathrel{=}{}\<[25]%
\>[25]{}(\mathbin{-}\Varid{b},\mathbin{-}\Varid{c}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{g4}\;(\Conid{E},(\Varid{b},\Varid{c}))\mathrel{=}{}\<[20]%
\>[20]{}(\Varid{expd}\;\Varid{b},(\Varid{expd}\;\Varid{b})\mathbin{*}\Varid{c}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
