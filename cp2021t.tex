...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Catalan (n+1) = Catalan n * 2(2n+1)/(n+2)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  f 0 = 2}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  f (n+1) = 4 + f n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  g 0 = 2}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  g (n+1) = 1 + g n}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  f/g = 2(2n+1)/(n+2)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  para ser divisao inteira:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  catalan (n+1) = (catalan n * f n)/(g n)}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{catalan}\mathbin{::}\Conid{Integer}\to \Conid{Integer}{}\<[E]%
\\
\>[B]{}\Varid{catalan}\;\mathrm{0}\mathrel{=}\mathrm{1}{}\<[E]%
\\
\>[B]{}\Varid{catalan}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{catalan}\;\Varid{n}\mathbin{*}\Varid{f}\;\Varid{n})\mathbin{\Varid{`div`}}\Varid{g}\;(\Varid{n}\mathbin{+}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f}\mathbin{::}\Conid{Integer}\to \Conid{Integer}{}\<[E]%
\\
\>[B]{}\Varid{f}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{f}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{4}\mathbin{+}\Varid{f}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{g}\mathbin{::}\Conid{Integer}\to \Conid{Integer}{}\<[E]%
\\
\>[B]{}\Varid{g}\;\mathrm{0}\mathrel{=}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{g}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{1}\mathbin{+}\Varid{g}\;\Varid{n}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\;(\Varid{catalan},\Varid{f},\Varid{g})\mathrel{=}((\Varid{catalan}\mathbin{*}\Varid{f})\mathbin{\Varid{`div`}}\Varid{g},\mathrm{4}\mathbin{+}\Varid{f},\mathrm{1}\mathbin{+}\Varid{g}){}\<[E]%
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  k :: [Double] -> Double  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k [a] = 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k (h:t) = 1 + k t}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  average :: [Double] -> Double }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  average [a] = a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  average (h:t) = h + (k t * average t) / (1 + k t)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Fokkinga:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.in    = h.F<avg,length>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.in = k.F<avg,length>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.[nil,cons]    = h.(id + id * <avg,length>)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.[nil,cons] = k.(id + id * <avg,length>)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.[nil,cons]    = [h1,h2].(id + id * <avg,length>)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.[nil,cons] = [k1,k2].(id + id * <avg,length>)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.nil     = h1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.cons    = h2.(id * <avg,length>)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.nil  = k1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.cons = k2.(id * <avg,length>)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg []       = h1 []}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg (h:t)    = h2(h,(avg t,length t))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length []    = k1 []}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length (h:t) = k2(h,(avg t,length t))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  logo:}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h1 = const 0}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h2 = (p1 + p2.p1 * p2.p2)/succ.p2.p2}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k1 = const 0}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k2 = succ.p2.p2}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h1 [] = 0}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h2 (a,(b,c)) = (a + b * c)/(c+1)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k1 [] = 0}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k2 (a,(b,c)) = c+1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg_aux = (\ensuremath{[\mskip1.5mu (\mathrm{0},\mathrm{0}),\mathbin{<}\Varid{h2},\Varid{k2}\mathbin{>}\mskip1.5mu]})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avg\char95 aux}\mathrel{=}\Varid{cataList}\;\alt{\conj{\underline{\mathrm{0}}}{\underline{\mathrm{0}}}}{\conj{\Varid{y}}{\Varid{x}}}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{x}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}\mathrm{1}\mathbin{+}\Varid{c}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{y}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{a}\mathbin{+}\Varid{b}\mathbin{*}\Varid{c})\mathbin{/}(\mathrm{1}\mathbin{+}\Varid{c}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\mbox{\onelinecomment  k :: [Double] -> Double  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k (Leaf a) = 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k (Node (a,b)) = k a + k b}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  average :: [Double] -> Double }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  average (Leaf a) = a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  average (Node (a,b)) = (average a * length a + average b * length b)/(length a + length b)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  Fokkinga:}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.[Leaf,Node]    = h.(id + <avg,length>²)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.[Leaf,Node] = k.(id + <avg,length>²)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.[Leaf,Node]    = [h1,h2].(id + <avg,length>²)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.[Leaf,Node] = [k1,k2].(id + <avg,length>²)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.Leaf     = h1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg.Node     = h2.(<avg,length>²)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.Leaf  = k1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length.Node  = k2.(<avg,length>²)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg (Leaf a)        = h1 a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  avg (Node (a,b))    = h2((avg a,length a),(avg b,length b))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length (Leaf a)     = k1 a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  length (Node (a,b)) = k2((avg a,length a),(avg b,length b))}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  logo:}{}\<[E]%
...
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h1 = id}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h2 = (p1.p1 * p1.p2 + p2.p1 * p2.p2)/(p1.p2 + p2.p2)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k1 = const 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k2 = p1.p2 + p2.p2}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  <=>}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h1 a = a}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  h2 ((a,b),(c,d)) = (a * b + c * d)/(b + d)}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k1 a = 1}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  k2 ((a,b),(c,d)) = b + d}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  }{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment  gene = (\ensuremath{[\mskip1.5mu \mathbin{<}\Varid{id},\underline{\mathrm{1}}\mathbin{>},\mathbin{<}\Varid{h2},\Varid{k2}\mathbin{>}\mskip1.5mu]})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{avgLTree}\mathrel{=}\p1\comp \llparenthesis\, \Varid{gene}\,\rrparenthesis\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{gene}\mathrel{=}\alt{\conj{\Varid{id}}{\underline{\mathrm{1}}}}{\conj{\Varid{z}}{\Varid{w}}}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{z}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a}\mathbin{*}\Varid{b}\mathbin{+}\Varid{c}\mathbin{*}\Varid{d})\mathbin{/}(\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{w}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}\Varid{b}\mathbin{+}\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
